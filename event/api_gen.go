...
func (z *API) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "Tags":
			...
			if z.Tags == nil {
				z.Tags = make(map[string]interface{}, zb0003)
...
func (z *API) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 13
	// write "Version"
	err = en.Append(0x8d, 0xa7, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e)
	if err != nil {
		return
	}
...
func (z *API) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 13
	// string "Version"
	o = append(o, 0x8d, 0xa7, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e)
...
func (z *API) Msgsize() (s int) {
	s = 1 + 8 + msgp.StringPrefixSize + len(z.Version) + 13 + msgp.StringPrefixSize + len(z.DeploymentID) + 9 + msgp.StringPrefixSize + len(z.SiteName) + 5 + msgp.TimeSize + 5 + msgp.StringPrefixSize + len(z.Node) + 7 + msgp.StringPrefixSize + len(string(z.Origin)) + 5 + msgp.StringPrefixSize + len(z.Type) + 5 + msgp.StringPrefixSize + len(z.Name) + 7 + msgp.StringPrefixSize + len(z.Bucket) + 7 + msgp.StringPrefixSize + len(z.Object) + 10 + msgp.StringPrefixSize + len(z.VersionID) + 5 + msgp.MapHeaderSize
	if z.Tags != nil {
		for za0001, za0002 := range z.Tags {
			_ = za0002
