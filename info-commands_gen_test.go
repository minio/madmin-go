...
func TestMarshalUnmarshalAPIVersion(t *testing.T) {
	v := APIVersion{}
...
func BenchmarkMarshalMsgAPIVersion(b *testing.B) {
	v := APIVersion{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgAPIVersion(b *testing.B) {
	v := APIVersion{}
...
func BenchmarkUnmarshalAPIVersion(b *testing.B) {
	v := APIVersion{}
...
func TestEncodeDecodeAPIVersion(t *testing.T) {
	v := APIVersion{}
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeAPIVersion Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeAPIVersion(b *testing.B) {
	v := APIVersion{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkDecodeAPIVersion(b *testing.B) {
	v := APIVersion{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalBackendVersion(t *testing.T) {
	v := BackendVersion{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgBackendVersion(b *testing.B) {
	v := BackendVersion{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgBackendVersion(b *testing.B) {
	v := BackendVersion{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalBackendVersion(b *testing.B) {
	v := BackendVersion{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeBackendVersion(t *testing.T) {
	v := BackendVersion{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeBackendVersion Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeBackendVersion(b *testing.B) {
	v := BackendVersion{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeBackendVersion(b *testing.B) {
	v := BackendVersion{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestEncodeDecodeCPU(t *testing.T) {
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeCPU Msgsize() is inaccurate")
	}
...
func TestMarshalUnmarshalHostInfoStat(t *testing.T) {
	v := HostInfoStat{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func TestEncodeDecodeVersion(t *testing.T) {
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeVersion Msgsize() is inaccurate")
	}
