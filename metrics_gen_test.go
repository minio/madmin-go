...
func TestMarshalUnmarshalClusterAPIStats(t *testing.T) {
	v := ClusterAPIStats{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgClusterAPIStats(b *testing.B) {
	v := ClusterAPIStats{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgClusterAPIStats(b *testing.B) {
	v := ClusterAPIStats{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalClusterAPIStats(b *testing.B) {
	v := ClusterAPIStats{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeClusterAPIStats(t *testing.T) {
	v := ClusterAPIStats{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeClusterAPIStats Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeClusterAPIStats(b *testing.B) {
	v := ClusterAPIStats{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeClusterAPIStats(b *testing.B) {
	v := ClusterAPIStats{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
