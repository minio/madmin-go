...
func TestMarshalUnmarshalBatchJobSummaryStatus(t *testing.T) {
	v := BatchJobSummaryStatus{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
	}
...
func BenchmarkMarshalMsgBatchJobSummaryStatus(b *testing.B) {
	v := BatchJobSummaryStatus{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgBatchJobSummaryStatus(b *testing.B) {
	v := BatchJobSummaryStatus{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalBatchJobSummaryStatus(b *testing.B) {
	v := BatchJobSummaryStatus{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeBatchJobSummaryStatus(t *testing.T) {
	v := BatchJobSummaryStatus{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeBatchJobSummaryStatus Msgsize() is inaccurate")
	}

	vn := BatchJobSummaryStatus{}
	err := msgp.Decode(&buf, &vn)
	if err != nil {
		t.Error(err)
	}
...
func BenchmarkEncodeBatchJobSummaryStatus(b *testing.B) {
	v := BatchJobSummaryStatus{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeBatchJobSummaryStatus(b *testing.B) {
	v := BatchJobSummaryStatus{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
