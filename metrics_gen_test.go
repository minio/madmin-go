...
func TestMarshalUnmarshalLastWindowAPIData(t *testing.T) {
	v := LastWindowAPIData{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgLastWindowAPIData(b *testing.B) {
	v := LastWindowAPIData{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgLastWindowAPIData(b *testing.B) {
	v := LastWindowAPIData{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalLastWindowAPIData(b *testing.B) {
	v := LastWindowAPIData{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeLastWindowAPIData(t *testing.T) {
	v := LastWindowAPIData{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeLastWindowAPIData Msgsize() is inaccurate")
	}

	vn := LastWindowAPIData{}
	err := msgp.Decode(&buf, &vn)
	if err != nil {
		t.Error(err)
	}
...
func BenchmarkEncodeLastWindowAPIData(b *testing.B) {
	v := LastWindowAPIData{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeLastWindowAPIData(b *testing.B) {
	v := LastWindowAPIData{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
