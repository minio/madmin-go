...
func (z *RPCMetrics) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "ConnectionStats":
			err = z.ConnectionStats.DecodeMsg(dc)
			if err != nil {
				err = msgp.WrapError(err, "ConnectionStats")
				return
			}
		case "lastMinute":
			var zb0002 uint32
...
func (z *RPCMetrics) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if zb0001Len != 0 {
		...
		err = en.Append(0xaf, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x73)
		if err != nil {
			return
		}
		err = z.ConnectionStats.EncodeMsg(en)
		if err != nil {
			err = msgp.WrapError(err, "ConnectionStats")
			return
		}
...
func (z *RPCMetrics) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if zb0001Len != 0 {
		...
		o = append(o, 0xaf, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x73)
		o, err = z.ConnectionStats.MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "ConnectionStats")
			return
		}
...
func (z *RPCMetrics) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "ConnectionStats":
			bts, err = z.ConnectionStats.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "ConnectionStats")
				return
			}
...
func (z *RPCMetrics) Msgsize() (s int) {
	s = 1 + 6 + msgp.IntSize + 10 + msgp.TimeSize + 16 + z.ConnectionStats.Msgsize() + 11 + msgp.MapHeaderSize
	if z.LastMinute != nil {
		for za0001, za0002 := range z.LastMinute {
			_ = za0002
			s += msgp.StringPrefixSize + len(za0001) + za0002.Msgsize()
