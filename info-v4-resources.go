...
type SMARTInfo struct {
	...
	MaxTemperature  float64 `json:"maxTemperature" msg:"mt,omitempty"`    // Accumulated temperature in Celsius
	MaxFailureRisk  float64 `json:"maxFailureRisk" msg:"mfr,omitempty"`   // Max annual failure rate (0.0-1.0+)
